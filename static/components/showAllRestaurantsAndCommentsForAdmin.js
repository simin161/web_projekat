...
template: `<div>
		...
		<form class="searchForm" style="">
			...
			<input type="button" value="Pretraži restorane" class="aaa" @click="showModal = true"></input>
			<input type="button" value="Prikaži sve restorane" class="aaa" @click="showAll()"></input>
		</form>
		<hr>
			<div>
				<div v-for="item in restaurants">
					<div class="lists">
